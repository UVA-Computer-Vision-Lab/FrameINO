...
def download_files(output_directory, start_zip_idx, end_zip_idx):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--start_zip_idx', type=int, help='Path to the dataset directory', default="/path/to/dataset")
    parser.add_argument('--end_zip_idx', type=int, help='Path to the dataset directory', default="/path/to/dataset")
    args = parser.parse_args()

    # Download
    download_files(args.output_directory, args.start_zip_idx, args.end_zip_idx)
